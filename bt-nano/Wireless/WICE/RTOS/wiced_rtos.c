...
wiced_worker_thread_t wiced_hardware_io_worker_thread = {NULL};
wiced_worker_thread_t wiced_networking_worker_thread = {NULL};

static xTaskHandle  app_thread_handle = NULL;
#ifndef WICED_DISABLE_WATCHDOG
static xTaskHandle  system_monitor_thread_handle = NULL;
