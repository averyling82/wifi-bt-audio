...
#define HARDWARE_IO_WORKER_THREAD_STACK_SIZE                                   (512)//(512)
#endif
...
#define NETWORKING_WORKER_THREAD_STACK_SIZE                               (512*2)//(7 * 1024)
#endif
#define NETWORKING_WORKER_THREAD_QUEUE_SIZE                                     (30)
