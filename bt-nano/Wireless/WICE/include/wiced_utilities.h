...
#define realloc_named( name, ptr, size )      rkos_memory_realloc( ptr, size )
#define malloc_named( name, size )            rkos_memory_malloc( size )
#define malloc_named_hideleak( name, size )   rkos_memory_malloc ( size )
