 ...
 * +----------+-----------------+
 */
#define WICED_NETWORK_WORKER_PRIORITY      (45)
#define WICED_DEFAULT_WORKER_PRIORITY      (47)
#define WICED_DEFAULT_LIBRARY_PRIORITY     (47)
#define WICED_APPLICATION_PRIORITY         (49)
