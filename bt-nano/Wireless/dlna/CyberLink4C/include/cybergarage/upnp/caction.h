...
#define RK_UPNP_ACTION_OPTIMIZE 1

/****************************************
* Data Type
****************************************/

#if RK_UPNP_ACTION_OPTIMIZE
...
#if RK_UPNP_ACTION_OPTIMIZE
#define cg_upnp_action_setname(action, value) cg_string_setvalue(action->name, value)// hac 2015/9/29 
#else
#define cg_upnp_action_setname(action, value) cg_xml_node_setchildnode(cg_upnp_action_getactionnode(action), CG_UPNP_ACTION_NAME, value)
#endif
...
#if RK_UPNP_ACTION_OPTIMIZE
#define cg_upnp_action_getname(action) cg_string_getvalue(action->name)// hac 2015/9/29
#else
#define cg_upnp_action_getname(action) cg_xml_node_getchildnodevalue(cg_upnp_action_getactionnode(action), CG_UPNP_ACTION_NAME)
#endif
