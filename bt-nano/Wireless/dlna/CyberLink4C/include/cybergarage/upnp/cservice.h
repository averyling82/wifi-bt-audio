...
#define RK_UPNP_SERVICE_OPTIMIZE 1

    /****************************************************************************
    * Data Type
    *****************************************************************************/

#if RK_UPNP_SERVICE_OPTIMIZE

    typedef struct _RkUpnpServiceNode
    {
        CgString *serviceType;
        CgString *serviceId;
        CgString *scpdurl;
        CgString *controlurl;
        CgString *eventSuburl;
    }RkUpnpServiceNode;
    ...
    typedef struct _CgUpnpService
    {
        ...
        RkUpnpServiceNode *rkServiceNode;
...
#define cg_upnp_service_isparsed(service) (service->parsed)
     ...
     */
#if RK_UPNP_SERVICE_OPTIMIZE
#define cg_upnp_service_setservicetype(service, value) cg_string_setvalue(service->rkServiceNode->serviceType, value)// hac 2015/9/29
#else
...
#if RK_UPNP_SERVICE_OPTIMIZE
#define cg_upnp_service_getservicetype(service) cg_string_getvalue(service->rkServiceNode->serviceType)// hac 2015/9/29
#else
#define cg_upnp_service_getservicetype(service) cg_xml_node_getchildnodevalue(cg_upnp_service_getservicenode(service), CG_UPNP_SERVICE_TYPE)
#endif
...
#if RK_UPNP_SERVICE_OPTIMIZE
#define cg_upnp_service_setserviceid(service, value) cg_string_setvalue(service->rkServiceNode->serviceId, value)// hac 2015/9/29
#else
#define cg_upnp_service_setserviceid(service, value) cg_xml_node_setchildnode(cg_upnp_service_getservicenode(service), CG_UPNP_SERVICE_ID, value)
#endif
...
#if RK_UPNP_SERVICE_OPTIMIZE
#define cg_upnp_service_getserviceid(service) cg_string_getvalue(service->rkServiceNode->serviceId)// hac 2015/9/29
#else
#define cg_upnp_service_getserviceid(service) cg_xml_node_getchildnodevalue(cg_upnp_service_getservicenode(service), CG_UPNP_SERVICE_ID)
#endif
...
#if RK_UPNP_SERVICE_OPTIMIZE
#define cg_upnp_service_setscpdurl(service, value) cg_string_setvalue(service->rkServiceNode->scpdurl, value)// hac 2015/9/29
#else
#define cg_upnp_service_setscpdurl(service, value) cg_xml_node_setchildnode(cg_upnp_service_getservicenode(service), CG_UPNP_SERVICE_SCPDURL, value)
#endif
...
#if RK_UPNP_SERVICE_OPTIMIZE
#define cg_upnp_service_setcontrolurl(service, value) cg_string_setvalue(service->rkServiceNode->controlurl, value)// hac 2015/9/29
#else
#define cg_upnp_service_setcontrolurl(service, value) cg_xml_node_setchildnode(cg_upnp_service_getservicenode(service), CG_UPNP_SERVICE_CONTROL_URL, value)
#endif
...
#if RK_UPNP_SERVICE_OPTIMIZE
#define cg_upnp_service_seteventsuburl(service, value) cg_string_setvalue(service->rkServiceNode->eventSuburl, value)// hac 2015/9/29
#else
#define cg_upnp_service_seteventsuburl(service, value) cg_xml_node_setchildnode(cg_upnp_service_getservicenode(service), CG_UPNP_SERVICE_EVENT_SUB_URL, value)
#endif
