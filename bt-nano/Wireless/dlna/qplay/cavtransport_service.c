...
__attribute__((used, section("__CG_UPNPAV_DMR_AVTRANSPORT_SERVICE_DESCRIPTION")))static char CG_UPNPAV_DMR_AVTRANSPORT_SERVICE_DESCRIPTION[] =
...
BOOL cg_upnpav_dmr_avtransport_init(CgUpnpAvRenderer *dmr)
{
    ...
    if (!service)
     ...
     {
        rk_printf("xml get avtransport fail\n");
        return NULL;
     }
