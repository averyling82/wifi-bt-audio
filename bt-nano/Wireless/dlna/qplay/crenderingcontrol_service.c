...
__attribute__((used, section("__CG_UPNPAV_DMR_RENDERINGCONTROL_SERVICE_DESCRIPTION"))) static char CG_UPNPAV_DMR_RENDERINGCONTROL_SERVICE_DESCRIPTION[] =
#else
#endif
...
BOOL cg_upnpav_dmr_renderingctrl_init(CgUpnpAvRenderer *dmr)
{
    ...
    if (!service)
     ...
     {
        rk_printf("xml dmr render control get fail\n");
        return NULL;
     }
