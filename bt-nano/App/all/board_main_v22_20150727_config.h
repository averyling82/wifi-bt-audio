...
*/
/*  system start LED B5 */
#define SYSTEM_START_LED_GPIO_CH    GPIO_CH1
#define SYSTEM_START_LED_GPIO_PIN   GPIOPortC_Pin5
#define SYSTEM_START_LED_ON_STATE  ( GPIO_LOW)
#define SYSTEM_START_LED_OFF_STATE  ( GPIO_HIGH)

/*  wifi LED B4 */
#define WIFI_STATE_LED_GPIO_CH    GPIO_CH1
#define WIFI_STATE_LED_GPIO_PIN   GPIOPortC_Pin4//wifi connect status
